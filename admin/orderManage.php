        ...
        <table class="table table-striped table-hover text-center" id="NoOrder">
            ...
            <tbody>
                <?php
                    ...
                    $sql = "SELECT tc.*, ti.*, ts.*, tp.*, tz.pizzaPrice 
                            FROM `viewcart` tc 
                            ...
                            WHERE ti.status_id IN(2, 3, 4, 5, 6) 
                            ORDER BY ti.order_id DESC";
                    ...
                    if($counter == 0) {
                        echo '<script> document.getElementById("NoOrder").innerHTML = "<div class=\'alert alert-info alert-dismissible fade show\' role=\'alert\' style=\'width:100%\'> You have not Received any Order! </div>";</script>';
                    } 
                ?>
            </tbody>
        </table>
