            ...
            while($row = mysqli_fetch_assoc($result)){
                ...
                echo '<div class="col-xs-3 col-sm-3 col-md-3">
                        <div class="card" style="width: 18rem;">
                            <img src="img/prod-'.$pizzaId. '.jpg" class="card-img-top" alt="image for this pizza" width="249px" height="270px">
                            <div class="card-body">
                          ...
                          <h6 style="color: #ff0000">₱ '.$pizzaPrice. '/-</h6>
                             <div class="row justify-content-center">';
                                if($loggedin){
                                    ...
                                    echo '<button class="btn btn-primary mx-2" data-toggle="modal" data-target="#loginModal"><i class="icofont-cart"></i>Add to Cart</button>';
                                }
